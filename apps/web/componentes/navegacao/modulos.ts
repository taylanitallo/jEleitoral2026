...
export const GRUPOS: GrupoModulos[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      { href: '/campo/entrevistas', rotulo: 'Registro', permissao: 'campo.ler' },
      { href: '/campo/qualidade', rotulo: 'Qualidade', permissao: 'qualidade.ler' },
    ],
  },
  {
    id: 'planejamento',
...
export const ICONE_POR_ROTA: Record<string, LucideIcon> = {
  ...
  '/campo/entrevistas': History,
  '/campo/qualidade': ShieldAlert,
